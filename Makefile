...
train-squad/colab:
	python3 run.py --do_train --task qa --dataset squad --output_dir "$(DRIVE_PATH)/trained_model_squad/" --save_steps 25000 --per_device_train_batch_size 60

train-hotpot/colab:
	python3 run.py --do_train --task qa --dataset hotpot_qa:fullwiki --output_dir "$(DRIVE_PATH)/trained_model_hotpot_qa/" --save_steps 25000 --per_device_train_batch_size 100
